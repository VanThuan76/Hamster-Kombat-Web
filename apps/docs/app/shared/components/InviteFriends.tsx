...
const InviteFriends = () => {
    const handleInviteFriends = () => {
        TelegramWebApps.WebApp.showPopup({
            ...
            buttons: [
                { id: 'invite', type: 'link', text: 'Invite', link: 'tg://user?id=invite' },
    ...
    return (
        <Button className="w-full h-[60px] bg-[#5a60ff]/85 hover:bg-[#5a60ff] text-white rounded-2xl scale-animated" onClick={handleInviteFriends}>
            Mời bạn bè
