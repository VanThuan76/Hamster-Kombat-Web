...
import { Drawer, DrawerClose, DrawerContent, DrawerTrigger } from "@ui/components/drawer"
            ...
            <DialogHeader className="p-4">
                <DialogDescription className="w-full flex justify-between items-center">
                    <div className="flex flex-[0.5] flex-col justify-start items-start gap-1 pr-5">
                        ...
                        <Progress
                            value={progress}
                            className="w-full h-[6px] bg-[#ffffff26] border border-[hsla(0,0%,100%,.1)]"
                        />
                    </div>
                    <div className="flex justify-between items-center bg-[#ffffff26] border border-white/10 rounded-[20px] text-white flex-1 h-[40px] relative py-1 px-4">
                        ...
                        <Separator orientation="vertical" className="bg-[#fff6]" />
            ...
            <Card className="card-has-glow w-full min-h-[140vh] border-none">
                ...
                <CardContent className="mt-5">
                    <Tabs defaultValue={tabListMine[0]?.toLowerCase()} className="w-full">
                        ...
                        <TabsContent value={tabListMine[0]?.toLowerCase() as string} className="w-full grid grid-cols-2 justify-start items-start gap-3">
                            {taskListMine.map((item, i) => {
                                return (
                                    <Drawer>
                                        <DrawerTrigger key={i} className="bg-[#272a2f] text-white rounded-2xl select-none p-3">
                                        ...
                                        <DrawerContent className="card-has-glow w-full h-[70%] md:h-[65%] border-none">
                                        </DrawerContent>
                                    </Drawer>
                                )
                            })}
