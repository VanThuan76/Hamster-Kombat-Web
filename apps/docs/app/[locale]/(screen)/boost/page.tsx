                        ...
                        <div className="w-full flex justify-between items-center rounded-2xl min-h-[64px] px-3 bg-[#272a2f] cursor-pointer">
                            <div className="flex justify-start items-center gap-4">
                                <MotionContainer className="p-3" type="scale">
                                    <Image src="/project/icon_flash.svg" alt="@flash" width={32} height={32} priority />
                                </MotionContainer>
                    ...
                    drawerContent={
                        <div className="w-full flex flex-col justify-center items-center gap-8">
                            <div className="relative z-10">
                                <Image src="/project/icon_flash.svg" alt="@icon_flash" width={115} height={115} priority />
                            </div>
                ...
                <div className="w-full flex justify-between items-center rounded-2xl min-h-[64px] px-3 bg-[#272a2f] opacity-50">
                    <div className="flex justify-start items-center gap-4">
                        <MotionContainer type="scale">
                            <Image src="/project/icon_rocket.png" alt="@icon_rocket" width={52} height={52} priority />
                        </MotionContainer>
                        <div className="flex flex-col justify-start items-start">
                ...
                <DrawerMinCard
                    drawerTrigger={
                        <div className="w-full flex justify-between items-center rounded-2xl min-h-[64px] px-3 bg-[#272a2f] cursor-pointer">
                            <div className="flex justify-start items-center gap-4">
                                <MotionContainer type="scale">
                                    <Image src="/project/icon_boost-multitap.png" alt="@multitap" width={52} height={52} priority />
                                </MotionContainer>
                                <div className="flex flex-col justify-start items-start">
                    ...
                    drawerContent={
                        <div className="w-full flex flex-col justify-center items-center gap-8">
                            <div className="relative z-10">
                                <Image src="/project/icon_boost-multitap.png" alt="@multitap" width={115} height={115} priority />
                            </div>
                            <div className="w-full flex flex-col justify-center items-center gap-5">
                ...
                <DrawerMinCard
                    drawerTrigger={
                        <div className="w-full flex justify-between items-center rounded-2xl min-h-[64px] px-3 bg-[#272a2f] cursor-pointer">
                            <div className="flex justify-start items-center gap-4">
                                <MotionContainer type="scale">
                                    <Image src="/project/icon_boost-energy.png" alt="@icon_boost" width={52} height={52} priority />
                                </MotionContainer>
                                <div className="flex flex-col justify-start items-start">
                    ...
                    drawerContent={
                        <div className="w-full flex flex-col justify-center items-center gap-8">
                            <div className="relative z-10">
                                <Image src="/project/icon_boost-energy.png" alt="@icon_boost-energy" width={115} height={115} priority />
                            </div>
                            <div className="w-full flex flex-col justify-center items-center gap-5">
