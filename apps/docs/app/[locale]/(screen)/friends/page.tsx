    ...
    return (
        <div className="relative w-full h-screen p-5 pb-40 space-y-2 overflow-y-auto text-center bg-black">
            ...
            <MotionContainer direction="left">
                <TypographySmall text={t('des_invite_friends')} className="mt-5 text-base text-white" />
            </MotionContainer>
            ...
            {!isOpenBonus ?
                ...
                :
                <div className="flex flex-col items-start justify-start gap-2 pt-2 cursor-pointer" onClick={() => setIsOpenBonus(false)} >
                    <TypographySmall text={t('more_bonuses_two')} className="text-2xl font-bold text-white" />
                    ...
                    {friends?.map(friend => {
                        return (
                            <div className="flex items-center justify-between gap-2">
                                <TypographySmall text={friend.first_name + friend.last_name} className="text-[#fff]" />
                                <TypographySmall text={String(friend.highest_score)} className="text-[#fff]" />
                            </div>
                        )
                    })}
                </div>
