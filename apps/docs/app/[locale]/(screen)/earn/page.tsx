          ...
          ?.earn.map((earn, i) => {
            return (
              <div
                key={i}
                className={cn(
                  "w-full flex justify-between items-center rounded-2xl min-h-[64px] px-3 ]",
                  earn.is_completed === 1 ? "bg-[#272a2fb3]" : "bg-[#272a2f]",
                )}
                onClick={() => {
                ...
                <div className="flex items-center justify-start gap-2">
                  ...
                  <div className="flex flex-col items-start justify-start">
                    ...
                    <div className="flex items-center justify-center gap-1">
                      ...
                      <TypographySmall
                        text={`+${formatCoinStyleDot(earn.reward)}`}
          ...
          <div className="flex items-center justify-start gap-2">
            ...
            <div className="flex flex-col items-start justify-start">
              ...
              <div className="flex items-center justify-center gap-1">
                <CoinIcon width={20} height={20} />
                <TypographySmall
                  text={`+${formatCoinStyleDot(earns.find((item) => item.type === 3)?.earn.reduce((a, b) => a + b.reward, 0) || 0)}`}
                  className="text-[14px] text-white ml-1"
                />
              </div>
            </div>
