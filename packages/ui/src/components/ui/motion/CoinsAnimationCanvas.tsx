...
interface CoinsAnimationCanvasProps {
    isAnimating: boolean;
}

const CoinsAnimationCanvas: React.FC<CoinsAnimationCanvasProps> = ({ isAnimating }) => {
